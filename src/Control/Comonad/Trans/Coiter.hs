...
-- | This is a coiter comonad of some functor @f@, with a comonad @w@ threaded through it at each level.
...
coiterT :: Comonad w => (w a -> w a) -> w a -> CoiterT w a
coiterT psi = CoiterT . extend (extract &&& coiterT psi . psi)
